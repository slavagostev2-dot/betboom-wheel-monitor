...
- `monitor_health.py` — heartbeat и сигнал controlled recovery для watchdog;
...
- `admin-bot.yml` — Control Center на exact SHA из release-marker;
- `monitor.yml` — монитор; успешная смена запускает преемника, ошибочную
