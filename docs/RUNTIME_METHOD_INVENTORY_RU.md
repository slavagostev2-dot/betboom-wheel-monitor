...
### `admin_panel_runtime_v10.py` — 82 строк, в рабочей цепочке

Прямые импорты: `admin_bot`, `admin_panel_runtime_v9`

Класс `TelegramPanelRuntimeV10`; база: `TelegramPanelRuntimeV9`.

- `setup_bot()` — 8 строк
- `show_app_entry()` — 10 строк
- `handle_message()` — 13 строк

### `admin_panel_runtime_v11.py` — 169 строк, в рабочей цепочке

Прямые импорты: `admin_panel_runtime_v10`, `admin_panel_runtime_v5`

Класс `TelegramPanelRuntimeV11`; база: `TelegramPanelRuntimeV10`.

- `miniapp_deployment()` — 9 строк
- `show_app_entry()` — 24 строк
- `show_discovery()` — 50 строк
- `show_candidate_list()` — 42 строк

### `admin_panel_runtime_v12.py` — 115 строк, в рабочей цепочке

Прямые импорты: `admin_panel_runtime_v11`

Класс `TelegramPanelRuntimeV12`; база: `TelegramPanelRuntimeV11`.

- `_callback_page()` — 4 строк
- `nav_rows()` — 13 строк
- `with_nav()` — 41 строк

Класс `_NavigationTestPanel`; база: `TelegramPanelRuntimeV12`.

- `__init__()` — 3 строк

### `admin_panel_runtime_v13.py` — 76 строк, в рабочей цепочке

Прямые импорты: `admin_panel_runtime_v12`

Класс `TelegramPanelRuntimeV13`; база: `TelegramPanelRuntimeV12`.

- `intelligence_launch_text()` — 7 строк
- `handle_callback()` — 34 строк

### `admin_panel_runtime_v14.py` — 442 строк, в рабочей цепочке
...
Класс `TelegramPanelRuntimeV15`; база: `TelegramPanelRuntimeV14`.

- `show_more()` — 10 строк
- `pending_rows()` — 17 строк
- `pending_reason()` — 9 строк
- `show_pending()` — 32 строк
- `show_stats()` — 36 строк
- `render_page()` — 8 строк
...
### `admin_panel_runtime_v24.py` — 222 строк, вне рабочей цепочки

Прямые импорты: `admin_panel_runtime_v21`, `admin_panel_runtime_v23`

Класс `TelegramPanelRuntimeV24`; база: `TelegramPanelRuntimeV23`.

- `compact_menu_rows()` — 27 строк
- `show_sources()` — 43 строк
- `show_ranking()` — 34 строк
- `show_active()` — 56 строк
- `render_page()` — 14 строк
...
- `__init__()` — `admin_panel_runtime_v12`, `admin_panel_runtime_v14`, `admin_panel_runtime_v17`, `admin_panel_runtime_v23`, `admin_panel_runtime_v25`, `admin_panel_runtime_v34`, `admin_panel_runtime_v37`, `admin_panel_runtime_v8`
...
- `show_discovery()` — `admin_panel_runtime_v11`, `admin_panel_runtime_v3`, `admin_panel_runtime_v37`, `admin_panel_runtime_v5`
...
- `show_ranking()` — `admin_panel_runtime_v22`, `admin_panel_runtime_v24`, `admin_panel_runtime_v25`, `admin_panel_runtime_v30`, `admin_panel_runtime_v36`, `admin_panel_runtime_v38`
...
- `show_sources()` — `admin_panel_runtime_v22`, `admin_panel_runtime_v24`, `admin_panel_runtime_v25`, `admin_panel_runtime_v29`, `admin_panel_runtime_v3`, `admin_panel_runtime_v37`, `admin_panel_runtime_v8`
- `show_stats()` — `admin_panel_runtime_v15`, `admin_panel_runtime_v20`, `admin_panel_runtime_v22`, `admin_panel_runtime_v29`, `admin_panel_runtime_v31`, `admin_panel_runtime_v32`, `admin_panel_runtime_v37`, `admin_panel_runtime_v38`
